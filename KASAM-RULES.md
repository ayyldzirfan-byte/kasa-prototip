...
- Kontrol: `npm run test:cloud-live` yalnızca `KASAM_CLOUD_EMAIL_A`, `KASAM_CLOUD_PASSWORD_A`, `KASAM_CLOUD_EMAIL_B`, `KASAM_CLOUD_PASSWORD_B` verildiğinde çalışır; eksik env durumunda exit code 2 ile durur.
